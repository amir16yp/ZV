...
public partial class LlvmGenerator
{
    private LLVMValueRef GenerateBuiltinCall(string name, List<Expression> arguments)
    {
        return name switch
        {
            ...
            "resource_count" => GenerateResourceCountCall(arguments),
            "resource_name" => GenerateResourceNameCall(arguments),
            "resource_ptr" => GenerateResourcePtrCall(arguments),
            "resource_size" => GenerateResourceSizeCall(arguments),
            "file_count" => GenerateFileCountCall(arguments),
            "file_name" => GenerateFileNameCall(arguments),
            "file_ptr" => GenerateFilePtrCall(arguments),
            "file_size" => GenerateFileSizeCall(arguments),
            "find_file" => GenerateFindFileCall(arguments),
